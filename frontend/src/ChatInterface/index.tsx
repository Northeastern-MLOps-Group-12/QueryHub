...
// --- ICONS ---
const BotIcon = () => <i className="bi bi-robot fs-5"></i>;
const UserIcon = () => <i className="bi bi-person fs-5"></i>;
const PlusIcon = () => <i className="bi bi-plus-lg"></i>;
...
export default function ChatInterface(): JSX.Element {
  ...
  return (
    <div className="d-flex mt-2" style={{ height: "100vh", minHeight: 600 }}>
      ...
      >
        <div
          className="p-2 ms-2 border-bottom d-flex justify-content-between align-items-center bg-body-tertiary"
          style={{
            position: "sticky",
            top: 0, // height of top navbar
            zIndex: 5,
          }}
        >
          <button
      ...
      >
        {/* HEADER */}
        <div
          className="p-3 border-bottom d-flex align-items-center bg-body-tertiary"
          style={{
            position: "sticky",
            top: "66px",
            zIndex: 5,
