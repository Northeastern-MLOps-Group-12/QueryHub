...
def get_gcs_bucket():
    ...
    bucket_name = os.getenv("GCS_VECTORSTORE_BUCKET_NAME")
    # credentials_path = os.getenv("GCS_CREDENTIALS_PATH")
    
    # if not bucket_name:
    #     raise ValueError("GCS_VECTORSTORE_BUCKET_NAME environment variable not set")
    ...
    try:
        ...
        return f"gs://{bucket.name}/{gcs_prefix}"
            ...
            raise Exception(
                ...
                f"Bucket: {os.getenv('GCS_VECTORSTORE_BUCKET_NAME')}, Project: {os.getenv('PROJECT_ID')}"
            ) from e
